...
function createElemento(elemento: string, id: string, text: string){
  return function(constructor: any){
...
class Text1{
  ...
  function createElemento1(elemento: string, id: string, text: string){
    return function(constructor: any){
  ...
  class Text2{
    ...
    function createElemento2(elemento: string, id: string, text: string){
      return function(constructor: any){
